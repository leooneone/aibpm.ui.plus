...
export class MyUserApi<SecurityDataType = unknown> extends HttpClient<SecurityDataType> {
  /**
   * No description
   *
   * @tags my-user
  ...
  getUser = (
    ...
    this.request<ResultOutputUserEntity, any>({
      path: `/api/bpm/my-user/get-user`,
      method: 'GET',
      query: query,
      secure: true,
      format: 'json',
