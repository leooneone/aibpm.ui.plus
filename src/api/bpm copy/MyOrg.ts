...
export class MyOrg<SecurityDataType = unknown> extends HttpClient<SecurityDataType> {
  /**
   * No description
   *
   * @tags my-org
   * @name GetEmployeeIds
   * @summary 获取组织内所有员工
   * @request GET:/api/bpm/my-org/get-employee-ids
   * @secure
   */
  getEmployeeIds = (
    query?: {
    ...
    this.request<ResultOutputListInt64, any>({
      path: `/api/bpm/my-org/get-employee-ids`,
      method: 'GET',
      query: query,
      secure: true,
      format: 'json',
