...
<script setup lang="ts" name="example/pagesFormRules">
import { defineAsyncComponent, reactive, ref } from 'vue'
import { ElMessage } from 'element-plus'

// 引入组件
const FormRulesOne = defineAsyncComponent(() => import('./component/formRulesOne.vue'))
const FormRulesTwo = defineAsyncComponent(() => import('./component/formRulesTwo.vue'))
const FormRulesThree = defineAsyncComponent(() => import('./component/formRulesThree.vue'))
