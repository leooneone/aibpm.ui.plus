<template>
  <div class="home-container layout-pd">
    <el-alert type="error" style="margin-bottom:15px">由于看板需要显示的信息因人而异，暂时仅提供静态参考页面，可根据自身需求自行定制实现！</el-alert>
        ...
        <div class="home-card-item flex">
          <div class="flex-margin flex w100" :class="` home-one-animation${k}`">
            <div class="flex-auto">
              ...
              <span class="ml5 font16" ><el-tag :type="v.type">{{ v.num2 }}%</el-tag></span>
              <div class="mt10 font20">{{ v.num3 }}</div>
            </div>
    ...
    <el-row :gutter="15" class="home-card-three">
      <el-col :xs="24" :sm="10" :md="10" :lg="8" :xl="8">
        <div class="home-card-item">
          <div class="home-card-item-title">快捷入口导航</div>
...
const initLineChart = () => {
  ...
  const option = {
    ...
    legend: { data: ['总流程数', '我发起的流程'], right: 0 },
    xAxis: {
...
const initPieChart = () => {
  ...
  var getname = ['工单管理', '财务管理', '人事管理', '行政管理']
  var getvalue = [34.2, 38.87, 17.88, 11.1]
  var data = []
...
const initBarChart = () => {
  ...
  const option = {
    ...
    tooltip: { trigger: 'axis' },
    legend: { data: [ '已完成', '未完成','异常'], right: 0 },
